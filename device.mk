...
PRODUCT_COPY_FILES += \
   device/asus/T00F/Album/lib/arm/libdrmstream_depjb.so:system/app/Album/lib/arm/libdrmstream_depjb.so \
   device/asus/T00F/Album/lib/arm/libgifreader.so:system/app/Album/lib/arm/libgifreader.so \
   device/asus/T00F/Album/lib/arm/libimagecalc.so:system/app/Album/lib/arm/libimagecalc.so \
   device/asus/T00F/Album/lib/arm/libjpeguser.so:system/app/Album/lib/arm/libjpeguser.so \
   device/asus/T00F/Album/lib/arm/libmaketc.so:system/app/Album/lib/arm/libmaketc.so \
   device/asus/T00F/Album/lib/arm/libnativeio.so:system/app/Album/lib/arm/libnativeio.so \
   device/asus/T00F/Album/lib/arm/libsceniccore.so:system/app/Album/lib/arm/libsceniccore.so \
   device/asus/T00F/Album/lib/arm/libspf.so:system/app/Album/lib/arm/libspf.so \
   device/asus/T00F/Album/oat/x86/base.odex:system/app/Album/oat/x86/base.odex \
   device/asus/T00F/Album/Album.apk:system/app/Album/Album.apk

# DotOS bootanimation

PRODUCT_COPY_FILES += \
   device/asus/T00F/Bootanimation/bootanimation.zip:system/media/bootanimation.zip
   
# Steven Black Ad block

PRODUCT_COPY_FILES += \
    device/asus/T00F/adblock/hosts:system/etc/hosts \

# Sony Music
PRODUCT_COPY_FILES += \
   device/asus/T00F/Music/Music.apk:system/priv-app/Music/Music.apk
